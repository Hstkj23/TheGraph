// src/lib.rs
/*
 * Core library for TheGraphWallet
 */
...
#[derive(Debug)]
pub struct TheGraphWalletProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TheGraphWalletProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TheGraphWallet processing");
    
    let mut processor = TheGraphWalletProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TheGraphWalletProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TheGraphWalletProcessor::new(false);
